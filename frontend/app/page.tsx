...
export default function Home() {
  ...
  try {
    ...
    console.error("Could not load comparison data.");
  }
}
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  min={1}
                  onChange={(e) =>
                    setMinDeficit(Number(e.target.value))
                  }
              ...
              <div>
                ...
                <input
                  ...
                  min={1}
                  onChange={(e) =>
                    setMaxDeficit(Number(e.target.value))
                  }
                  className="w-full rounded-lg border border-zinc-700 bg-zinc-950 px-3 py-2"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setMinFavoriteBy(Number(e.target.value))
                  }
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={endSeason}
                    onChange={(e) =>
                      setEndSeason(Number(e.target.value))
                    }
                    className="w-full rounded-lg border border-zinc-700 bg-zinc-950 px-3 py-2"
                  />
                </div>
...
<div className="mt-8 rounded-2xl border border-zinc-800 bg-zinc-900 p-6">
  <div className="mb-6">
    ...
    <p className="mt-1 text-sm text-zinc-500">
      See how historical win probability changes as filters are added.
    </p>
  </div>
